...
// settings
const size_t    c_imageSize_hang = 392; const size_t    c_imageSize_lie = 216; const bool      c_doDFT = true;
...
char name[] = "D:\\study\\GHOST\\deeplearning_ghostimage\\cpppinknoise\\pink216x392\\";
char* fileName = name;
//======================================================================================
struct SImageData
{
